...
- Name: lab_upload_flow.spec.ts >> Lab Upload Flow >> complete lab upload and visualization flow
- Location: src\__tests__\e2e\lab_upload_flow.spec.ts:20:7
...
Locator: getByText('No lab results found')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('No lab results found')
