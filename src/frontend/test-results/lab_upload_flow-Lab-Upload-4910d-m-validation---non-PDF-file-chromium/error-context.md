...
- Name: lab_upload_flow.spec.ts >> Lab Upload Flow >> upload form validation - non-PDF file
- Location: src\__tests__\e2e\lab_upload_flow.spec.ts:90:7
        ...
        - generic [ref=e9]:
          ...
          - generic [ref=e15]:
            ...
            - button "Upload" [ref=e17]:
              ...
              - text: Upload
        - generic [ref=e18]:
          - generic [ref=e19]: Loading lab results...
          - generic [ref=e22]: Loading chart...
...
```ts
  ...
  4   | 
  5   | /**
  6   |  * E2E test for the complete lab upload flow:
  7   |  * 1. Upload a sample PDF
  8   |  * 2. Verify processing
  9   |  * 3. Verify table displays results
  10  |  * 4. Verify chart renders
  11  |  */
  12  | 
